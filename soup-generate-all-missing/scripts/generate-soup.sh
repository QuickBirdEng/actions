    ...
    '{
        ...
        "requirements": {
            ...
            "grq-3": (
                ...
                {
                    description: "SOUP is maintained and support is available",
                    fulfilled: $fulfilled,
                    fulfilled_visual: (if $fulfilled then "\u2705" else "\u274C" end),
                    reason_if_requirement_not_fulfilled: "",
                    metadata: {
            ...
            "grq-4": (
                ...
                {
                    description: "SOUP does not contain major or critical security issues.",
                    fulfilled: $fulfilled,
                    fulfilled_visual: (if $fulfilled then "\u2705" else "\u274C" end),
                    reason_if_requirement_not_fulfilled: "",
                    metadata: $cve_info
            ...
            "grq-5": (
                ...
                {
                    description: "SOUP provider is reliable, trustworthy and communicative",
            ...
            "grq-6": (
                ...
                {
                    description: "SOUP conforms to Semantic Versioning",
                    fulfilled: $fulfilled,
                    fulfilled_visual: (if $fulfilled then "\u2705" else "\u274C" end),
                    reason_if_requirement_not_fulfilled: "",
                    metadata: {
