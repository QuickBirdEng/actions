#!/usr/bin/env python3
"""Maintenance release windows (WI-006-09-01: The maintenance window).
...
2. **A missed window does not move the grid.** It advances from the missed due date, not from
   ...
   receding deadline that WI-006-09-01: Classification of a finding's latching exists to prevent.
